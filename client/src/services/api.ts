...
export const drawingApi = {
  ...
  async getDrawing(id: string): Promise<ApiResponse<Drawing>> {
    try {
      const response = await api.get<ApiResponse<Drawing>>(`/api/drawings/${id}`);
      return response.data;
    } catch (error) {
  ...
  async createDrawing(data: CreateDrawingRequest): Promise<ApiResponse<Drawing>> {
    try {
      const response = await api.post<ApiResponse<Drawing>>('/api/drawings', data);
      return response.data;
    } catch (error) {
  ...
  async deleteDrawing(id: string): Promise<ApiResponse<null>> {
    try {
      const response = await api.delete<ApiResponse<null>>(`/api/drawings/${id}`);
      return response.data;
    } catch (error) {
